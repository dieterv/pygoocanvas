...
def setup_canvas (canvas):
    global ellipse1, ellipse2, rect1, rect2, rect3, rect4, root

    canvas.set_root_item_model (root)

    # Absolute.
    ellipse1 = goocanvas.EllipseModel (parent = root,
                                       center_x = 0,
                                       center_y = 0,
                                       radius_x = 25,
                                       radius_y = 15,
    ...
    rect1 = goocanvas.RectModel (parent = root,
                                 x = -10,
                                 y = -10,
                                 width = 20,
                                 height = 20,
    ...
    rect3 = goocanvas.RectModel (parent = root,
                                 x = -10,
                                 y = -10,
                                 width = 20,
                                 height = 20,
    ...
    # Relative.
    ellipse2 = goocanvas.EllipseModel (parent = root,
                                       center_x = 0,
                                       center_y = 0,
                                       radius_x = 25,
                                       radius_y = 15,
    ...
    rect2 = goocanvas.RectModel (parent = root,
                                 x = -10,
                                 y = -10,
                                 width = 20,
                                 height = 20,
    ...
    rect4 = goocanvas.RectModel (parent = root,
                                 x = -10,
                                 y = -10,
                                 width = 20,
                                 height = 20,
